...
console.log(results);
draw_sketch = document.getElementById().innerHTML = "Your Sketch : " + results[0].label;
confidence = document.getElementById().innerHTML = "confidence : " + results[0].confidence;
your_sketch = draw_sketch;
